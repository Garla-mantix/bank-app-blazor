...
public interface IAccountService
{
    ...
    Task WithdrawAsync(Guid accountId, decimal amount, BudgetCategory category);
    Task TransferAsync(Guid fromAccountId, Guid toAccountId, decimal amount,  BudgetCategory category); 
